        ...
        if (context.mounted) {
          final result = await showDialog<bool>(
            ...
            builder: (BuildContext dialogContext) => AlertDialog(
              ...
              title: const Text('Предупреждение о сертификате'),
              content: Column(
                mainAxisSize: MainAxisSize.min,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                    'Сертификат для $host не является доверенным на вашем устройстве. Это может указывать на угрозу безопасности.',
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Продолжайте только если доверяете этому роутеру и понимаете риски безопасности.',
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(
              'Сертификат для $host:$port не является доверенным на вашем устройстве. Это может указывать на угрозу безопасности.',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildCertDetail('Субъект', certificate.subject),
                  _buildCertDetail('Издатель', certificate.issuer),
                  _buildCertDetail(
                    'Действителен с',
