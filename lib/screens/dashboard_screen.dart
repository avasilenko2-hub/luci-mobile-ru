      ...
      if (uciValues != null) {
        ...
        uciInterfaces.forEach((uciName, config) {
          if (!addedInterfaces.contains(uciName)) {
            final ssid = config['ssid'] ?? 'Без имени';
                                  ...
                                  children: [
                                    ...
                                    ...routers.map((r) {
                                      ...
                                      return ListTile(
                                        ...
                                        title: Tooltip(
                                          message: isStale
                                              ? 'Последнее известное имя (может быть устаревшим)'
                                              : '',
                                          child: Text(
                                            routerTitle,
                                            style: Theme.of(context)
  ...
  Widget _buildBody(AppState appState) {
    ...
    if (appState.dashboardData == null) {
      return LuciEmptyState(
        title: 'Нет данных',
        message:
            'Не удалось получить данные панели. Потяните вниз для обновления или нажмите кнопку ниже.',
