  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<Client>>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          appBar: const LuciAppBar(title: 'Клиенты'),
          body: Stack(
            children: [
              LuciPullToRefresh(
                onRefresh: () async {
                  ...
                  builder: (context) {
                    ...
                    if (dashboardError != null && aggregatedClients.isEmpty) {
                      return LuciErrorDisplay(
                        ...
                        message:
                            'Не удалось подключиться к роутеру. Проверьте сетевое подключение и IP-адрес роутера.',
                        ...
                        Padding(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: 'Поиск по имени, IP, MAC, производителю...',
                          ...
                          child: filteredClients.isEmpty
                              ? LuciEmptyState(
                                  ...
                                  message: _searchQuery.isEmpty
                                      ? 'Сейчас к роутеру не подключён ни один клиент. Потяните вниз, чтобы обновить список.'
                                      : 'Нет клиентов, соответствующих запросу. Попробуйте изменить условия поиска.',
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            ...
                            semanticsLabel:
                                'Имя клиента: ${widget.client.hostname}',
                            maxLines: 1,
                          ...
                          Text(
                            ...
                            semanticsLabel:
                                'Сведения о клиенте: ${_buildMinimalClientSubtitle(widget.client)}',
                          ),
                          if (widget.client.vendor != null &&
                            ...
                            Text(
                              ...
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                              semanticsLabel: 'Производитель: ${widget.client.vendor}',
                            ),
                        ],
                      ),
                    ),
      ...
      child: Column(
        children: [
          detailRow(
            ...
            client.ipAddress,
            onTap: () =>
                _copyToClipboard(context, client.ipAddress, 'IP-адрес'),
            semanticsLabel: 'IP-адрес: ${client.ipAddress}',
          ),
          if (client.ipv6Addresses != null && client.ipv6Addresses!.isNotEmpty)
            ...client.ipv6Addresses!.map(
              (ipv6) => detailRow(
                ...
                semanticsLabel: 'IPv6-адрес: $ipv6',
              ),
            ),
          detailRow(
            'MAC-адрес',
            client.macAddress,
            onTap: () =>
                _copyToClipboard(context, client.macAddress, 'MAC-адрес'),
            semanticsLabel: 'MAC-адрес: ${client.macAddress}',
          ),
          if (client.vendor != null && client.vendor!.isNotEmpty)
            detailRow(
              'Производитель',
              client.vendor!,
              semanticsLabel: 'Производитель: ${client.vendor}',
            ),
          if (client.dnsName != null && client.dnsName!.isNotEmpty)
            detailRow(
              'DNS-имя',
              client.dnsName!,
              semanticsLabel: 'DNS-имя: ${client.dnsName}',
            ),
          const Divider(height: 1, indent: 16, endIndent: 16),
          ...
          detailRow(
            ...
            valueColor: client.formattedLeaseTime == 'Истёк'
                ? theme.colorScheme.error
                : null,
            semanticsLabel:
                'Остаток аренды: ${client.formattedLeaseTime}',
          ),
          const SizedBox(height: 8),
        ],
      ),
