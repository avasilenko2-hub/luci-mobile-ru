    ...
    showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          title: const Text('Включить режим рецензента?'),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text(
                'Это включит режим рецензента, который обходит аутентификацию '
                'и предоставляет тестовые данные для демонстрации приложения.',
              ),
              const SizedBox(height: 16),
              const Text(
                'Для подтверждения введите "REVIEWER" ниже:',
  ...
  Future<void> _connect() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (!parsedUrl.isValid) {
        // Show error message
        appState.setError(parsedUrl.error ?? 'Неверный формат адреса');
        return;
      }
  ...
  Future<void> _openGitHubIssues() async {
    ...
    if (!success && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Не удалось открыть GitHub issues'),
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              Column(
                                children: [
                                  ...
                                  Text(
                                    'Подключитесь к роутеру OpenWrt',
                                        ...
                                        child: AnimatedBuilder(
                                          ...
                                          builder: (context, child) {
                                            return Column(
                                              children: [
                                                Text(
                                                  'Удерживайте, чтобы включить режим рецензента...',
                                    ...
                                    builder: (context) {
                                      ...
                                      return Column(
                                        ...
                                        children: <Widget>[
                                          Tooltip(
                                            message:
                                                'Введите IP-адрес, имя хоста или полный URL роутера',
                                            child: TextFormField(
                                          ...
                                          Tooltip(
                                            message:
                                                'Введите имя пользователя роутера',
                                            child: TextFormField(
                        ...
                        const SizedBox(height: 16),
                        Tooltip(
                          message: 'Открыть GitHub issues для поддержки',
                          child: TextButton(
